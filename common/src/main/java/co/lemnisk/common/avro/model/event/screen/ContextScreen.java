...
public class ContextScreen extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7570561988710660454L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ContextScreen\",\"namespace\":\"co.lemnisk.common.avro.model.event.screen\",\"fields\":[{\"name\":\"width\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"height\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"density\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder newBuilder() {
    return new co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder();
  }
   ...
   * @return A new ContextScreen RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder newBuilder(co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder other) {
    return new co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder(other);
  }
   ...
   * @return A new ContextScreen RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder newBuilder(co.lemnisk.common.avro.model.event.screen.ContextScreen other) {
    return new co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ContextScreen>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.screen.ContextScreen other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.width)) {
        this.width = data().deepCopy(fields()[0].schema(), other.width);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder setWidth(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder clearWidth() {
      width = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder setHeight(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder clearHeight() {
      height = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder setDensity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.screen.ContextScreen.Builder clearDensity() {
      density = null;
