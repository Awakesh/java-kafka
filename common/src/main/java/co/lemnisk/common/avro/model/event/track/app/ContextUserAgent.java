...
public class ContextUserAgent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5289759662091053072L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ContextUserAgent\",\"namespace\":\"co.lemnisk.common.avro.model.event.track.app\",\"fields\":[{\"name\":\"osType\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"osVersion\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder newBuilder() {
    return new co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder();
  }
   ...
   * @return A new ContextUserAgent RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder newBuilder(co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder other) {
    return new co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder(other);
  }
   ...
   * @return A new ContextUserAgent RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder newBuilder(co.lemnisk.common.avro.model.event.track.app.ContextUserAgent other) {
    return new co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ContextUserAgent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.track.app.ContextUserAgent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.osType)) {
        this.osType = data().deepCopy(fields()[0].schema(), other.osType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder setOsType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder clearOsType() {
      osType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder setOsVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.app.ContextUserAgent.Builder clearOsVersion() {
      osVersion = null;
