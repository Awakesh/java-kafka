...
public class ContextScreen extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5839546133780768189L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ContextScreen\",\"namespace\":\"co.lemnisk.common.avro.model.event.identify.app\",\"fields\":[{\"name\":\"width\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"height\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"density\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder newBuilder() {
    return new co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder();
  }
   ...
   * @return A new ContextScreen RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder newBuilder(co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder other) {
    return new co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder(other);
  }
   ...
   * @return A new ContextScreen RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder newBuilder(co.lemnisk.common.avro.model.event.identify.app.ContextScreen other) {
    return new co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ContextScreen>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.identify.app.ContextScreen other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.width)) {
        this.width = data().deepCopy(fields()[0].schema(), other.width);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder setWidth(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder clearWidth() {
      width = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder setHeight(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder clearHeight() {
      height = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder setDensity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.identify.app.ContextScreen.Builder clearDensity() {
      density = null;
