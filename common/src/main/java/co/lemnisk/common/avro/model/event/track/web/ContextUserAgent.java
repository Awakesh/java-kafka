...
public class ContextUserAgent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5909478566992891347L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ContextUserAgent\",\"namespace\":\"co.lemnisk.common.avro.model.event.track.web\",\"fields\":[{\"name\":\"deviceType\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"osType\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"osVersion\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"browser\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"ua\",\"type\":\"string\",\"default\":\"\"}]}");
   ...
   */
  public static co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder newBuilder() {
    return new co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder();
  }
   ...
   * @return A new ContextUserAgent RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder newBuilder(co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder other) {
    return new co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder(other);
  }
   ...
   * @return A new ContextUserAgent RecordBuilder
   */
  public static co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder newBuilder(co.lemnisk.common.avro.model.event.track.web.ContextUserAgent other) {
    return new co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ContextUserAgent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.lemnisk.common.avro.model.event.track.web.ContextUserAgent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.deviceType)) {
        this.deviceType = data().deepCopy(fields()[0].schema(), other.deviceType);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder setDeviceType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder clearDeviceType() {
      deviceType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder setOsType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder clearOsType() {
      osType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder setOsVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder clearOsVersion() {
      osVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder setBrowser(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder clearBrowser() {
      browser = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder setUa(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.lemnisk.common.avro.model.event.track.web.ContextUserAgent.Builder clearUa() {
      ua = null;
