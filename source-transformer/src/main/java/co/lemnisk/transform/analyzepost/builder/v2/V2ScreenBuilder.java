...
public class V2ScreenBuilder {
    ...
    public V2ScreenBuilder(String data) throws JsonProcessingException {
        setRawData(data);
    }

    public V2ScreenBuilder setRawData(String rawData) throws JsonProcessingException {
